		...
		for (ll = 0; ll < M; ll++)
		{
			for (mm = 0; mm < N; mm++)
			{
				...
				if ((1-boolean_tens[L*M*mm + ll * L + kk]) < 1e-12)
				{
                    ...
                    total_panels[L*M*N * 24 + L * M*mm + ll * L + kk] = grid_intcon[L*M*N * 3 + L * M*mm + ll * L + kk];
                    ...
                    total_panels[L*M*N * 25 + L * M*mm + ll * L + kk] = grid_intcon[L*M*N * 3 + L * M*mm + ll * L + kk];
                    ...
                    total_panels[L*M*N * 26 + L * M*mm + ll * L + kk] = grid_intcon[L*M*N * 3 + L * M*mm + ll * L + kk];
					...
					//{
                        ...
                        total_panels[L*M*N * 27 + L * M*mm + ll * L + kk] = grid_intcon[L*M*N * 3 + L * M*mm + ll * L + kk];
					//}
					...
					//{
                        ...
                        total_panels[L*M*N * 29 + L * M*mm + ll * L + kk] = grid_intcon[L*M*N * 3 + L * M*mm + ll * L + kk];
					//}
