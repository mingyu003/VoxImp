function [JOut_full]=lse_matvect_mult1(JIn0, fN_all,fN_ch_all, A_ind,dim_ind, OneoverMc, dx, freq, idx,fl_sparseprecon,inds_glob,locs_diel_pos,ids_panel_diel,ids_panels,num_diel,ko,blk_pre,ids_pre,ord_pre,fl_Tuck)
...
if (fl_sparseprecon == 1)
    [JOut_full]=lse_sparse_precon_multiply(JOut_full,Ae,Aq,blk_pre,ids_pre,ord_pre);
end
