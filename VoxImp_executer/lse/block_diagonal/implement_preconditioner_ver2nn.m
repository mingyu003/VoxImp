function [precond,ids,ord]=implement_preconditioner_ver2nn(dx,num_vox_in_blk,L,M,N,geom_bndry_panels_test,Eps_inout,inds_glob,num_diel,freq)
...
for ii=1:3
    for jj=1:3
        fN_charge{ii,jj}=fN_charge{ii,jj};%/(2*pi*freq);
    end
end
