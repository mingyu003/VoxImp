...
[fN_ch_all{1,1,1}] = Toeplitz_JVIE_cap('G_xx_charge',L+1,M+1,N+1,G_mn_xx_c); % Gp_mn_xx
clear G_mn_xx_c

if (fl_diel == 1)   
    [fN_ch_all{1,1,2}] = Toeplitz_JVIE_cap('G_xx_Efield',L+1,M+1,N+1,G_mn_xx_e); % Gp_mn_xx
    clear G_mn_xx_e
end
...
[fN_ch_all{2,2,1}] = Toeplitz_JVIE_cap('G_yy_charge',L+1,M+1,N+1,G_mn_yy_c); % Gp_mn_yy
clear G_mn_yy_c
if (fl_diel == 1)
    [fN_ch_all{2,2,2}] = Toeplitz_JVIE_cap('G_yy_Efield',L+1,M+1,N+1,G_mn_yy_e); % Gp_mn_yy
    clear G_mn_yy_e
end
...
[fN_ch_all{3,3,1}] = Toeplitz_JVIE_cap('G_zz_charge',L+1,M+1,N+1,G_mn_zz_c); % Gp_mn_zz
clear G_mn_zz_c
if (fl_diel == 1)      
    [fN_ch_all{3,3,2}] = Toeplitz_JVIE_cap('G_zz_Efield',L+1,M+1,N+1,G_mn_zz_e); % Gp_mn_zz
    clear G_mn_zz_e
end
...
[fN_ch_all{1,2,1}] = Toeplitz_JVIE_cap('G_xy_charge',L+1,M+1,N+1,G_mn_xy_c); % Gp_mn_xy
clear G_mn_xy_c
if (fl_diel == 1)   
    [fN_ch_all{1,2,2}] = Toeplitz_JVIE_cap('G_xy_Efield',L+1,M+1,N+1,G_mn_xy_e); % Gp_mn_xy
    clear G_mn_xy_e
end
...
[fN_ch_all{1,3,1}] = Toeplitz_JVIE_cap('G_xz_charge',L+1,M+1,N+1,G_mn_xz_c); % Gp_mn_xz
clear G_mn_xz_c
if (fl_diel == 1) %%%%%%here can be optimized, but time display in 1.2.2 needs to be delete.!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! remove this part to 1.2.2
    if N==M
        ...
        [fN_ch_all{1,3,2}] = Toeplitz_JVIE_cap('G_xz_Efield',L+1,M+1,N+1,G_mn_xz_e); % Gp_mn_xz
        clear G_mn_xz_e
    end
end
...
[fN_ch_all{2,3,1}] = Toeplitz_JVIE_cap('G_yz_charge',L+1,M+1,N+1,G_mn_yz_c); % Gp_mn_yz
clear G_mn_yz_c
if (fl_diel == 1)
    [fN_ch_all{2,3,2}] = Toeplitz_JVIE_cap('G_yz_Efield',L+1,M+1,N+1,G_mn_yz_e); % Gp_mn_yz
    clear G_mn_yz_e
end
...
if (fl_diel == 1)
    ...
    if L==M
        ...
        [fN_ch_all{2,1,2}] = Toeplitz_JVIE_cap('G_yx_Efield',L+1,M+1,N+1,G_mn_yx_e); % Gp_mn_xy
        clear G_mn_yx_e
    end
    ...
    if L==N
        ...
        [fN_ch_all{3,1,2}] = Toeplitz_JVIE_cap('G_zx_Efield',L+1,M+1,N+1,G_mn_zx_e); % Gp_mn_xz
        clear G_mn_zx_e
    end
    ...
    if M==N
        ...
        [fN_ch_all{3,2,2}] = Toeplitz_JVIE_cap('G_zy_Efield',L+1,M+1,N+1,G_mn_zy_e); % Gp_mn_yz
        clear G_mn_zy_e
    end
